REPOSITORY_LOCATIONS = dict(
    bazel_gazelle = dict(
        ...
        git_repo = "https://github.com/bazelbuild/bazel-gazelle.git",
        git_sha = "c728ce9f663e2bff26361ba5978ec5c9e6816a3c",
    ),
    boringssl = dict(
        ...
        git_repo = "https://github.com/google/boringssl.git",
        git_sha = "060e9a583976e73d1ea8b2bfe8b9cab33c62fa17",
    ),
    com_google_absl = dict(
        ...
        git_sha = "cc8dcd307b76a575d2e3e0958a4fe4c7193c2f68",
    ),
    com_github_apache_thrift = dict(
        ...
        git_repo = "https://github.com/apache/thrift.git",
        git_sha = "327ebb6c2b6df8bf075da02ef45a2a034e9b79ba",
    ),
    com_github_bombela_backward = dict(
        ...
        git_repo = "https://github.com/bombela/backward-cpp.git",
        git_sha = "84ae4f5e80381aca765a0810d4c811acae3cd7c7",
    ),
    com_github_circonus_labs_libcircllhist = dict(
        ...
        git_repo = "https://github.com/circonus-labs/libcircllhist.git",
        git_sha = "fd8a14463739d247b414825cc56ca3946792a3b9",
    ),
    com_github_cyan4973_xxhash = dict(
        ...
        git_repo = "https://github.com/Cyan4973/xxHash.git",
        git_sha = "7cc9639699f64b750c0b82333dced9ea77e8436e",
    ),
    com_github_eile_tclap = dict(
        ...
        git_repo = "https://github.com/eile/tclap.git",
        git_sha = "3627d9402e529770df9b0edf2aa8c0e0d6c6bb41",
    ),
    com_github_fmtlib_fmt = dict(
        ...
        git_sha = "3e75ad9822980e41bc591938f26548f24eb88907",
    ),
    com_github_gabime_spdlog = dict(
        ...
        git_sha = "10e809cf644d55e5bd7d66d02e2604e2ddd7fb48",
    ),
    com_github_gcovr_gcovr = dict(
        ...
        git_repo = "https://github.com/gcovr/gcovr.git",
        git_sha = "c0d77201039c7b119b18bc7fb991564c602dd75d",
    ),
    com_github_google_libprotobuf_mutator = dict(
        ...
        git_repo = "https://github.com/google/libprotobuf-mutator.git",
        git_sha = "c3d2faf04a1070b0b852b0efdef81e1a81ba925e",
    ),
    com_github_grpc_grpc = dict(
        ...
        git_sha = "98457b76ff43efa2c3edd203c14cd923734d5279",
    ),
    com_github_nanopb_nanopb = dict(
        ...
        git_repo = "https://github.com/nanopb/nanopb.git",
        git_sha = "f8ac463766281625ad710900479130c7fcb4d63b",
    ),
    io_opentracing_cpp = dict(
        ...
        git_repo = "https://github.com/opentracing/opentracing-cpp.git",
        git_sha = "ac50154a7713877f877981c33c3375003b6ebfe1",
    ),
    com_lightstep_tracer_cpp = dict(
        ...
        git_repo = "https://github.com/lightstep/lightstep-tracer-cpp.git",
        git_sha = "172a7ed11289e9b8966e29844ba30b209c0b06c0",
    ),
    lightstep_vendored_googleapis = dict(
        ...
        git_sha = "/d6f78d948c53f3b400bb46996eb3084359914f9b",
    ),
    com_github_datadog_dd_opentracing_cpp = dict(
        ...
        git_repo = "https://github.com/DataDog/dd-opentracing-cpp.git",
        git_sha = "bf048b79060016f065ca079a884d74e71a4effd4",
    ),
    com_github_msgpack_msgpack_c = dict(
        ...
        git_repo = "https://github.com/msgpack/msgpack-c.git",
        git_sha = "83a82e3eb512b18d4149cabb7eb43c7e8bc081af",
    ),
    com_github_google_jwt_verify = dict(
        ...
        git_repo = "https://github.com/google/jwt_verify_lib.git",
        git_sha = "66792a057ec54e4b75c6a2eeda4e98220bd12a9a",
    ),
    com_github_nodejs_http_parser = dict(
        ...
        git_repo = "https://github.com/nodejs/http-parser.git",
        git_sha = "77310eeb839c4251c07184a5db8885a572a08352",
    ),
    com_github_pallets_jinja = dict(
        sha256 = "f84be1bb0040caca4cea721fcbbbbd61f9be9464ca236387158b0feea01914a4",
        strip_prefix = "Jinja2-2.10",
        urls = ["https://github.com/pallets/jinja/releases/download/2.10/Jinja2-2.10.tar.gz"],
        git_repo = "https://github.com/pallets/jinja.git",
        git_sha = "78d2f672149e5b9b7d539c575d2c1bfc12db67a9",
    ),
    com_github_pallets_markupsafe = dict(
        ...
        git_repo = "https://github.com/pallets/markupsafe.git",
        git_sha = "d2a40c41dd1930345628ea9412d97e159f828157",
    ),
    com_github_tencent_rapidjson = dict(
        sha256 = "bf7ced29704a1e696fbccf2a2b4ea068e7774fa37f6d7dd4039d0787f8bed98e",
        strip_prefix = "rapidjson-1.1.0",
        urls = ["https://github.com/Tencent/rapidjson/archive/v1.1.0.tar.gz"],
        git_repo = "https://github.com/Tencent/rapidjson.git",
        git_sha = "f54b0e47a08782a6131cc3d60f94d038fa6e0a51",
    ),
    com_github_twitter_common_lang = dict(
        ...
        git_repo = "https://github.com/twitter/commons.git",
        git_sha = "b97322f923bb75b3174693c739f7fca682d3fcd7",
    ),
    ...
    com_github_twitter_common_finagle_thrift = dict(
        ...
        git_repo = "https://github.com/twitter/commons.git",
        # The package contains generated code
        # It's produced using the following build rule
        #   commons/src/thrift/com/twitter/service/BUILD
        git_sha = "b97322f923bb75b3174693c739f7fca682d3fcd7",
    ),
    com_google_googletest = dict(
        ...
        git_sha = "2fe3bd994b3189899d93f1d5a881e725e046fdc2",
    ),
    com_google_protobuf = dict(
        ...
        git_sha = "fa252ec2a54acb24ddc87d48fed1ecfd458445fd",
    ),
    grpc_httpjson_transcoding = dict(
        ...
        git_repo = "https://github.com/grpc-ecosystem/grpc-httpjson-transcoding.git",
        git_sha = "05a15e4ecd0244a981fdf0348a76658def62fa9c",
    ),
    com_github_golang_protobuf = dict(
        ...
        git_repo = "https://github.com/golang/protobuf.git",
        git_sha = "31e0d063dd98c052257e5b69eeb006818133f45c",
    ),
    io_bazel_rules_go = dict(
        sha256 = "ee5fe78fe417c685ecb77a0a725dc9f6040ae5beb44a0ba4ddb55453aad23a8a",
        urls = ["https://github.com/bazelbuild/rules_go/releases/download/0.16.0/rules_go-0.16.0.tar.gz"],
        git_repo = "https://github.com/bazelbuild/rules_go.git",
        git_sha = "6fa12b1e3dcb6eae03a69a1383f354d091636b5e",
    ),
    six_archive = dict(
        sha256 = "105f8d68616f8248e24bf0e9372ef04d3cc10104f1980f54d57b2ce73a5ad56a",
        urls = ["https://pypi.python.org/packages/source/s/six/six-1.10.0.tar.gz#md5=34eed507548117b2ab523ab14b2f8b55"],
        git_repo = "https://github.com/benjaminp/six.git",
        git_sha = "c3ec058bf8c4d6329224eac53366c8e9ce511417",
    ),
    ...
    subpar = dict(
        ...
        git_repo = "https://github.com/google/subpar.git",
        git_sha = "07ff5feb7c7b113eea593eb6ec50b51099cf0261",
    ),
)
